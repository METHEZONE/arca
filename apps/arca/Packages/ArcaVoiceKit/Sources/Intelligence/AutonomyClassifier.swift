        ...
        let tool: [String: Any] = [
            ...
            "input_schema": [
                ...
                "properties": [
                    ...
                    "rationale": ["type": "string", "description": "One-line reason for this classification, in \(ArcaLanguageResolver.isKorean ? "Korean" : "English")"],
                    "executionPlan": ["type": "string", "description": "A concrete one-to-two sentence instruction ARCA would follow if it ran this in the background, in \(ArcaLanguageResolver.isKorean ? "Korean" : "English"). If manual, describe what the user needs to decide."],
